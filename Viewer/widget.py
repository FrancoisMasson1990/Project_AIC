...
class Axes(object):
    ...
    def properties(self,lc):
        ...
        self.axact.SetShaftTypeToCylinder()
        self.axact.SetCylinderRadius(0.03)
        self.axact.SetXAxisLabelText('x')
        self.axact.SetYAxisLabelText('y')
        self.axact.SetZAxisLabelText('z')
        self.axact.GetXAxisShaftProperty().SetColor(1, 0, 0)
        self.axact.GetYAxisShaftProperty().SetColor(0, 1, 0)
        self.axact.GetZAxisShaftProperty().SetColor(0, 0, 1)
        self.axact.GetXAxisTipProperty().SetColor(1, 0, 0)
        self.axact.GetYAxisTipProperty().SetColor(0, 1, 0)
        self.axact.GetZAxisTipProperty().SetColor(0, 0, 1)
        self.axact.GetXAxisCaptionActor2D().GetCaptionTextProperty().BoldOff()
        self.axact.GetYAxisCaptionActor2D().GetCaptionTextProperty().BoldOff()
        self.axact.GetZAxisCaptionActor2D().GetCaptionTextProperty().BoldOff()
        self.axact.GetXAxisCaptionActor2D().GetCaptionTextProperty().ItalicOff()
        self.axact.GetYAxisCaptionActor2D().GetCaptionTextProperty().ItalicOff()
        self.axact.GetZAxisCaptionActor2D().GetCaptionTextProperty().ItalicOff()
        self.axact.GetXAxisCaptionActor2D().GetCaptionTextProperty().ShadowOff()
        self.axact.GetYAxisCaptionActor2D().GetCaptionTextProperty().ShadowOff()
        self.axact.GetZAxisCaptionActor2D().GetCaptionTextProperty().ShadowOff()
        self.axact.GetXAxisCaptionActor2D().GetCaptionTextProperty().SetColor(lc)
        self.axact.GetYAxisCaptionActor2D().GetCaptionTextProperty().SetColor(lc)
        self.axact.GetZAxisCaptionActor2D().GetCaptionTextProperty().SetColor(lc)
        self.axact.PickableOff()

    def addIcon(self,size=0.1):
        
        self.widget.SetOrientationMarker(self.axact)
...
class Grid(object):
    def __init__(self,actor):
        ...
        self.grid = None
        self.axes = dict() # will cause popping the defaults
        self.axes_copy = 1
        self.actor = actor
        self.properties()
    ...
    def properties(self,c = (0.9, 0.9, 0.9)):
        ...
        numberOfDivisions = self.axes.pop('numberOfDivisions', nrDiv) # number of divisions on the shortest axis
        ...
        xTitlePosition = self.axes.pop('xTitlePosition', 0.95) # title fractional positions along axis [0->1]
        yTitlePosition = self.axes.pop('yTitlePosition', 0.95)
        zTitlePosition = self.axes.pop('zTitlePosition', 0.95)

        xTitleOffset = self.axes.pop('xTitleOffset', 0.05)  # title fractional offsets
        ...
        xyGrid2 = self.axes.pop('xyGrid2', False) # opposite side grid
        ...
        xLabelPrecision = self.axes.pop('xLabelPrecision', 2) # nr. of significant digits
