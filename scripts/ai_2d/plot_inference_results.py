...
if __name__ == "__main__":
    ...
    model_version = 1
    model_filename = \
        "/home/francoismasson/Project_AIC/Viewer/models" + \
        "/unet_model_for_aic_320.hdf5"
    ...
    trainFiles, trainLabels, \
        validateFiles, validateLabels, \
        testFiles, testLabels = ut.get_file_list(data_path=data_path)
