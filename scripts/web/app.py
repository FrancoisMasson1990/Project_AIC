...
@app.callback(
    dash.Output(component_id='outcomes',
                component_property='children'),
    dash.Input(component_id='age',
               component_property='value'),
    dash.Input(component_id='score',
               component_property='value'),
    dash.Input(component_id='sex',
               component_property='value'),
    dash.Input(component_id='renal',
               component_property='value'),
    dash.Input(component_id='gradient',
               component_property='value'),
    dash.Input(component_id='size',
               component_property='value'),
    dash.Input(component_id='ldl',
               component_property='value'),
    dash.Input(component_id='cholesterol',
               component_property='value'),
    dash.Input(component_id='implantation',
               component_property='value'),
    )
def update_outcome(age,
                   score,
                   sex,
                   renal,
                   gradient,
    ...
    if any(elem is None for elem in values):
        ...
        if isinstance(response, list):
            return f'Risque of reoperation after 2 years' + \
                   f' is {response[0]}' + \
